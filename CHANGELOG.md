...
* **flowtype:** set parser to babel-eslint ([22d2c35](https://github.com/anvilabs/eslint-config-anvilabs/commit/22d2c35))



<a name="6.2.1"></a>
## [6.2.1](https://github.com/anvilabs/eslint-config-anvilabs/compare/v6.2.0...v6.2.1) (2017-03-10)
...
* **base:** add support for updated prettier options ([0cb9f4a](https://github.com/anvilabs/eslint-config-anvilabs/commit/0cb9f4a))
* **react-native:** add missing globals ([dfe9820](https://github.com/anvilabs/eslint-config-anvilabs/commit/dfe9820))
